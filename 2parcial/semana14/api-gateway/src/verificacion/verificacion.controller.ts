...
export class VerificacionController {
  ...
  async create(@Body() createVerificacionDto: CreateVerificacionDto) {
    try {
      ...
      await this.webhookEmitter.emit('verificacion.creada', {
        verificacion: resultado,
        datosCreacion: createVerificacionDto,
      });
  ...
  async update(
    ...
    try {
      ...
      await this.webhookEmitter.emit('verificacion.actualizada', {
        verificacion: resultado,
        id,
        datosActualizacion: updateVerificacionDto,
      });
