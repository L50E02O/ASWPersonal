...
VALUES 
    ('11111111-1111-1111-1111-111111111111'::uuid, 'SEED-001', 4.5, 'Arquitecto senior con experiencia en diseno residencial', 'Diseno Residencial, Remodelaciones', 'Ciudad de Mexico', true, 120, '11111111-1111-1111-1111-111111111111'::uuid),
    ('22222222-2222-2222-2222-222222222222'::uuid, 'SEED-002', 4.8, 'Especialista en arquitectura sustentable', 'Arquitectura Sustentable, LEED', 'Guadalajara', true, 85, '22222222-2222-2222-2222-222222222222'::uuid),
    ('33333333-3333-3333-3333-333333333333'::uuid, 'SEED-003', 0.0, 'Arquitecto junior buscando oportunidades', 'Diseno de Interiores', 'Monterrey', false, 15, '33333333-3333-3333-3333-333333333333'::uuid),
    ('44444444-4444-4444-4444-444444444444'::uuid, 'SEED-004', 3.2, 'Experiencia en proyectos comerciales', 'Arquitectura Comercial, Retail', 'Puebla', false, 45, '44444444-4444-4444-4444-444444444444'::uuid),
    ('55555555-5555-5555-5555-555555555555'::uuid, 'SEED-005', 4.0, 'Especialista en restauracion historica', 'Restauracion, Patrimonio', 'Oaxaca', false, 60, '55555555-5555-5555-5555-555555555555'::uuid)
...
VALUES 
    ('verificado', '11111111-1111-1111-1111-111111111111'::uuid, '11111111-1111-1111-1111-111111111111'::uuid),
    ('verificado', '22222222-2222-2222-2222-222222222222'::uuid, '11111111-1111-1111-1111-111111111111'::uuid),
    ('pendiente', '33333333-3333-3333-3333-333333333333'::uuid, '11111111-1111-1111-1111-111111111111'::uuid),
    ('pendiente', '44444444-4444-4444-4444-444444444444'::uuid, '11111111-1111-1111-1111-111111111111'::uuid),
    ('rechazado', '55555555-5555-5555-5555-555555555555'::uuid, '11111111-1111-1111-1111-111111111111'::uuid);
"@
